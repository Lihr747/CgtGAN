...
def main(clip_model_type: str, coco_path: str):
    ...
    sentence_path = coco_path + f"/coco_train_sentences.pkl"
    caption_path = coco_path + f"/coco_{clip_model_name}_train_captions.pkl"
    ...
    data = sentences
    clip_model_name = clip_model_type.replace('/', '_')
    print("saving path:{}".format(caption_path))
